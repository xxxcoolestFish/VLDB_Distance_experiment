...
elif model_class in ('pos_sensing_gnn', 'pos_sensing_gnn_l1tilde'):
    from experiments.new_baselines.position_sensing_gnn import PositionSensingGNN

    use_lt = (model_class == 'pos_sensing_gnn_l1tilde')
    model = PositionSensingGNN(
        graph=G, num_nodes=num_nodes,
        node_attributes=node_attributes,
        edge_attributes=edge_attributes,
        layer_type=gnn_layer,
